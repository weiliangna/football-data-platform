...
.focus-grid article{display:flex;flex-direction:column}.focus-grid h3{display:flex;align-items:center;justify-content:flex-start;text-align:left;font-weight:700}.focus-grid article>div{display:grid;grid-template-columns:minmax(0,1fr) auto;grid-template-rows:auto auto;align-items:center;gap:7px 10px;padding:14px 13px;text-align:left}.focus-grid strong{grid-column:1;grid-row:1;font-size:14px}.focus-grid b{grid-column:2;grid-row:1;margin:0;color:#6551d9;font-size:13px;white-space:nowrap}.focus-grid small{grid-column:1/-1;grid-row:2;margin:0;color:var(--text-muted);font-size:10px}.focus-grid article:hover{border-color:#cfc7f4;box-shadow:0 8px 18px rgba(95,72,213,.08);transform:translateY(-1px);transition:.18s ease}
</style>
